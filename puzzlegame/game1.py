...
def run_beforegame(n):
    ...
    while n1:
        ...
        screen1.blit(yuantu, (30, 0))#加目标图片
        screen1.blit(startgame, (30, gameRect.height))#开始按钮
        screen1.blit(newimage,(gameRect.width-220,gameRect.height))#更换图片的按钮
        pygame.display.update()#刷新界面
        buttons = pygame.mouse.get_pressed()#鼠标点击按钮事件
